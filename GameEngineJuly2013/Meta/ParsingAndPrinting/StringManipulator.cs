...
namespace Meta.ParsingAndPrinting
{
	public class StringManipulator
	{
		...
		/// <summary>
		/// Makes a formatted list of all othe strings passed.
		/// </summary>
		/// <param name="listItems">the strings to make a list of</param>
		/// <returns>a formatted list</returns>
		public static string MakeAndList(params string[] listItems)
		{
			if (listItems.Length == 0) { return null; }

			else if (listItems.Length == 1) { return listItems[0]; }
				...
				for (int i = 0; i < listItems.Length - 1; i++) {
					temp += listItems[i] + ", "; }
				temp += "and " + listItems[listItems.Length - 1];
				return temp; }
		}
		...
		/// <param name="listItems">the strings to make a list of</param>
		/// <returns>a formatted list</returns>
		public static string MakeOrList(params string[] listItems)
		{
			if (listItems.Length == 0) { return null; }
				...
				for (int i = 0; i < listItems.Length - 1; i++) {
					temp += listItems[i] + ", "; }
				temp += "or " + listItems[listItems.Length - 1];
				return temp; }
		}
	}
}
